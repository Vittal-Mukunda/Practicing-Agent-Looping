...
| Requirement | Status |
|---|---|
| Length 6,000–8,000 words incl. everything, 250 per table/figure | **~6,600** ✓ |
| Structured abstract ≤250 words incl. keywords + classification | **243** ✓ |
| Four mandatory sub-headings (Purpose / Design / Findings / Originality) | ✓ |
| Keywords (up to 12) | 6 ✓ |
| Classification | Research paper; submission type "Original Article" ✓ |
| Headings: level 1 bold, sub-headings italic | ✓ |
| Tables in a separate file, Roman numerals | ✓ |
| Figures: .tif, numbered, captions | ✓ |
...
Submit through the journal's ScholarOne site only — not by email or any third party. You
will need a ScholarOne account for this journal. Expect a first decision within about 60
days.
